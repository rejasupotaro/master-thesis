...
def generate(train_size=0.8):
    ...
    get_logger().info(f'Large listwise dataset was created with {len(large_dataset)} groups')  # 1223992 groups
    ...
    get_logger().info(f'Medium listwise dataset was created with {len(medium_dataset)} groups')  # 162841 groups
